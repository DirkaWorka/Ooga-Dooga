 ...
 <body>
   ...
   <main class="wrapper">
     ...
     <p></p>
        ...
        $toAddress = "healyd197@gmail.com";  //place your/your client's email address here
        $toName = "Erica G"; //place your client's name here
        $website = "Diet Busters";  //place NAME of your client's website
